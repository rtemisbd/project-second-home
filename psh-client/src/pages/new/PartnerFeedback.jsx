...
import FeedBack1 from "../../assets/img/feadback1.jpeg";
import FeedBack2 from "../../assets/img/feadback2..jpeg";
import FeedBack3 from "../../assets/img/feadback3..jpeg";
                  ...
                  <div className="flex flex-col md:w-6/12 max-md:w-full max-md:ml-0">
                    <div className="flex grow flex-col items-stretch max-md:max-w-full">
                      <img
                        ...
                        src={FeedBack1}
                        style={{ width: "100%" }}
                        className=" w-full overflow-hidden max-md:max-w-full rounded  md:h-[380px] sm:h-[200px]"
                      />
                    </div>
                  </div>
                  <div className="flex flex-col  md:w-6/12 ml-5 max-md:w-full max-md:ml-0 mt-5">
                    <div className="flex  flex-col items-start max-md:max-w-full ">
                      <div className="flex text-emerald-50 text-3xl font-medium leading-8 self-stretch whitespace-nowrap max-md:max-w-full">
                        <svg
                      ...
                      <div className="justify-center mt-3">
                        <p className="feedback_p">
                          I am honored to come across PSH, an emerging Startup
                          and my sincere gratitude to all the team members who
                          are turning social problem into opportunity (PSH &
                          PFK, DayCare and Old Home). Dreams with dedication
                          brings success, you are the example. Investment coming
                          from different people make this company wonderful
                          which once again prove that unique idea is more
                          valuable than money. Wish you all the best and I
                          believe you will grow as big as your dream.
                        </p>
                      </div>

                      <div className="flex  items-center self-stretch whitespace-nowrap max-md:max-w-full feedback_pic">
                        <img
                          src={MaleImg}
                          alt=""
                        ...
                        <p className="ms-2">
                          {" "}
                          Md. Shafil Hosain (Telecom Consultant)
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div className="gap-5 md:flex max-md:flex-col max-md:items-stretch max-md:gap-0">
                  ...
                  <div className="flex flex-col items-stretch md:w-6/12 ml-5 max-md:w-full max-md:ml-0">
                    <div className="flex grow flex-col items-start max-md:max-w-full ">
                      ...
                      <div className="justify-center mt-3">
                        <p className="feedback_p">
                          I found that PSH offers secure investment
                          opportunities and they provide lucrative returns. As a
                          startup, they are doing good in different business
                          sectors. I believe that they will provide exceptional
                          customer service in the future arena. My best wishes
                          to the CEO, Ms. Sumona Sharmin and her team of Rtemis
                          Limited.
                        </p>
                      </div>
                      ...
                      <div className="flex  text-neutral-50 text-base leading-6 self-stretch whitespace-nowrap max-md:max-w-full feedback_pic">
                        ...
                        <p className=" ms-2">
                          {" "}
                          Zubayer Rashid (Senior HR admin, BAT)
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div className="gap-5 md:flex max-md:flex-col max-md:items-stretch max-md:gap-0">
                  ...
                  <div className="flex flex-col items-stretch md:w-6/12 ml-5 max-md:w-full max-md:ml-0">
                    <div className="flex grow flex-col items-start max-md:max-w-full ">
                      ...
                      <div className="justify-center mt-3">
                        <p className="feedback_p">
                          PSH is one of the unique & reliable start up business
                          & after visit its office I was inspired for invest &
                          it will bring smart profit also for investors. By this
                          project I am also feel proud to be a part of social
                          work, where its intention is for help bachelor's &
                          short time guest's to take rest for single day/night
                          with stay in Dhaka city during seasonal work related
                          with capital city. In previous & still now no one is
                          capable to stable for this type of project in Dhaka.
                          So it's both side view is remarkable till now. I am
                          expecting its better growth.
                        </p>
                      </div>

                      <div className="flex text-neutral-50 text-base self-stretch whitespace-nowrap max-md:max-w-full mt-7 ">
                        <img
                          src={MaleImg}
                          style={{ width: "20px", height: "20px" }}
                          alt=""
                        ...
                        <p className=" ms-2">
                          {" "}
                          Farhadur Reja Nayon (Investor, Project Second Home)
                        </p>
                      </div>
                    </div>
                  </div>
