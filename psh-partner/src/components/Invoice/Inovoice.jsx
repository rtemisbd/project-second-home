              ...
              <div>
                ...
                >
                  <div className="d-flex justify-content-between">
                    ...
                    <p className="">BDT {data?.bookingInfo?.subTotal}</p>
                  </div>

                  <div className="d-flex justify-content-between">
                    <p className="fw-bold">VAT </p>{" "}
                    <p className="ml-[70px]">:</p>
                    <p className="">BDT {data?.bookingInfo?.vatTax}</p>
                  </div>
                  <div className="d-flex justify-content-between">
                  ...
                  <div className="d-flex justify-content-between">
                    ...
                    <p className="">BDT {data?.totalAmount}</p>
                  </div>
                  <div className="d-flex justify-content-between">
                    ...
                    <p className="">BDT {data?.bookingInfo?.discount}</p>
                  </div>
                  <hr style={{ marginTop: "4px" }} />
